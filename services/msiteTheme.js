...
const THEMES = {
  ...
  meok: {
    ...
    ctaBg: '#241F18', ctaFg: '#FFFFFF', ctaAc: '#C9A469', ctaAcFg: '#1B1710',
  },
  /* 소나무 — 초록 */
  sol: {
    name: '소나무',
    ...
    ctaBg: '#1B2620', ctaFg: '#FFFFFF', ctaAc: '#6FBF93', ctaAcFg: '#102017',
  },
  /* 노을 — 붉은 기 */
  noeul: {
    name: '노을',
    ...
    ctaBg: '#2A1D1A', ctaFg: '#FFFFFF', ctaAc: '#E8836E', ctaAcFg: '#2A1D1A',
  },
  /* 새벽 — 남색 */
  saebyeok: {
    name: '새벽',
    ...
    ctaBg: '#1A202A', ctaFg: '#FFFFFF', ctaAc: '#7FA9DA', ctaAcFg: '#111721',
  },
  /* 밤 — 어두운 바탕 */
  bam: {
    name: '밤',
    ...
    /* 어두운 바탕이라 신청칸을 금색으로 띄운다.
       그러면 체크표시·단추는 거꾸로 짙은 색이어야 보인다. */
    ctaBg: '#C9A469', ctaFg: '#1B1710', ctaAc: '#1B1710', ctaAcFg: '#F2E4CC',
  },
};
...
function cssVars(key) {
  ...
  return [
    ...
    '--cta-bg:' + t.ctaBg, '--cta-fg:' + t.ctaFg,
    '--cta-ac:' + t.ctaAc, '--cta-ac-fg:' + t.ctaAcFg,
  ].join(';');
}
