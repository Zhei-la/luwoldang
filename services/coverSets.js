...
const BUILTIN_SETS = [
  {
    ...
    kinds: ['종합사주','신년운세','연애운','재회운','결혼운','연인궁합','재물운','건강운','무료사주','취업·직장운','이직운','자녀운','합격운','이동·이사운','인간관계운'],
  ...
  },
  {
    ...
    kinds: ['종합사주','신년운세','무료사주','연인궁합','연애운','재회운','결혼운','건강운','취업·직장운','이직운','자녀운','합격운','이동·이사운','인간관계운'], // 재물운 없음
  },
  {
    key: 'maehwa',
    name: '매화 · 낡은 종이',
    ...
    kinds: ['종합사주','신년운세','무료사주','연인궁합','연애운','재회운','결혼운','재물운','건강운','취업·직장운','이직운','자녀운','합격운','이동·이사운','인간관계운'],
  },
  {
    key: 'sumuk',
    name: '수묵 · 까치',
...
const ORIGINAL = {
  ...
  '취업·직장운': { img: '/img/pdf/cover-chwieop.jpg', style: 'circle', brandTop: 18.2 },
  '이직운':    { img: '/img/pdf/cover-ijik.jpg',    style: 'circle', brandTop: 18.2 },
  '자녀운': { img: '/img/pdf/cover-janyeo.jpg', style: 'circle', brandTop: 18.2 },
  '합격운': { img: '/img/pdf/cover-hapgyeok.jpg', style: 'circle', brandTop: 18.2 },
  '이동·이사운': { img: '/img/pdf/cover-isa.jpg', style: 'circle', brandTop: 18.2 },
  '인간관계운': { img: '/img/pdf/cover-ingan.jpg', style: 'circle', brandTop: 18.2 },
};
