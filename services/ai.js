...
### 쉼표 금지 (중요)
쉼표를 습관처럼 찍지 마세요. AI 글이 답답하게 읽히는 큰 이유입니다.

**쉼표를 써도 되는 경우는 딱 둘뿐입니다:**
1. 단어를 나열할 때 — "일, 사람, 돈"
2. 쉼표가 없으면 뜻이 실제로 헷갈릴 때

**그 외에는 전부 빼세요:**
❌ "남의 기분을 먼저 읽어버리는 탓에, 정작 내 감정을 놓칩니다."
✅ "남의 기분을 먼저 읽어버리는 탓에 정작 내 감정을 놓칩니다."

❌ "더 지치기 때문에, 알아차리는 것만으로 충분합니다."
✅ "더 지치기 때문에 알아차리는 것만으로 충분합니다."

❌ "이 시기에는, 특별한 기회가 옵니다."
✅ "이 시기에는 특별한 기회가 옵니다."

연결어미(~탓에 / ~때문에 / ~지만 / ~어서) 뒤에는 **쉼표를 찍지 마세요.**
쉼표 없이 그냥 이어가면 문장이 훨씬 매끄럽게 흐릅니다.
...
const BAD_PATTERNS = [
  ...
  // 연결어미 뒤 쉼표 — 나열이 아닌데 습관적으로 찍는 경우
  { re: /(탓에|때문에|덕분에|지만|어서|아서|하며|면서|으로써|보니|하니|라서|니까|므로|에는|에서는|하면)\s*,/g, label: '불필요한 쉼표' },
...
- 쉼표를 빼세요. 단어를 나열할 때 말고는 쉼표를 찍지 마세요. 연결어미 뒤에는 절대 안 됩니다.
