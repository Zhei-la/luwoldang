...
⚠️ **구체적으로 쓰세요.** "언제·어떤 상황에서·어떻게 행동하는지"가 없으면 누구에게나 해당되는 말이 됩니다.
⚠️ 각 소제목의 첫 문장은 결론부터. 용어 없이.`;
  ...
  const problems = [];
  blocks.forEach((b, i) => {
    const issues = checkStyle(b.body || '', client.name, { allowJargon: !spec });
...
**"누구에게나 해당되는 말"** 이라고 나왔다면:
  ...
  그 결과를 **이 사람만의 구체적인 장면**으로 바꿔 쓰세요.
...
**"구체적인 장면이 없음"** 이라고 나왔다면:
  형용사만 나열했다는 뜻입니다. **언제·어떤 상황에서·어떻게 행동하는지**를 넣으세요.
